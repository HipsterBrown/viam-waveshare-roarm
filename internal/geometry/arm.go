...
// ToolOffsetMM is the distance from the link5 (wrist-roll) frame to the
// gripper mount along the roll axis, from Waveshare's RoArm-M3 URDF
// (link5_to_gripper_link origin z = 0.052035 m). The "tool" link in
// roarm_m3.json carries this value; bench task B5 confirms it against the
// physical arm.
